(function() {
  var FileUpload, ParsedData, User, app, ascBy, descBy, dynamicSort, express, fileUpload, port, requiresLogin, utils;
  ...
  app.get("/generatedata/:rows?", requiresLogin, function(req, res) {
    var columns, data, dataGen, maleNames, nameCount, rows, surNames, surnameCount, transforms;
  ...
  app.get("/donations", requiresLogin, function(req, res) {
    var parsedData;
    parsedData = new ParsedData;
    return parsedData.getAll(function(err, data) {
  ...
  ascBy = function(arr, property) {
    return arr.sort(dynamicSort(property));
  };
  descBy = function(arr, property) {
