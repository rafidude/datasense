(function() {
  var CSV2JS, FileUpload, ParsedData, S3File, ascBy, auth_key, auth_secret, crypto, descBy, dynamicSort, fileUpload, getUploadParams, parseFile, parsedData, request, sanitize, template_id, toJS;
