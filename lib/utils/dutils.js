(function() {
  var CSV2JS, DataColl, DataGen, FileUpload, S3File, ascBy, auth_key, auth_secret, convertToCSV, crypto, dataColl, descBy, dynamicSort, fileUpload, getUploadParams, parseFile, request, sanitize, template_id, toJS;
      ...
      if (!error && response.statusCode === 200) {
        ...
        return s3.get(__bind(function(err, res) {
          ...
          if (err) {
            ...
            parsedRet = toJS(res);
            return dataColl.save(parsedRet.data, __bind(function(err, success) {
