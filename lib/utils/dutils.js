(function() {
  var CSV2JS, DataColl, FileUpload, S3File, ascBy, auth_key, auth_secret, crypto, dataColl, descBy, dynamicSort, fileUpload, getUploadParams, parseFile, request, sanitize, template_id, toJS;
